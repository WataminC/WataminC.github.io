...
### 语法制导翻译的方法有多少种？
1. 在确定的递归下降语法分析程序中，利用隐含堆栈存储各递归下降函数内的局部变量所表示的语义信息。
2. 在自底向上语法分析程序中使用和语法分析同步的语义栈进行语法分析翻译。
3. 在LL(1)语法分析程序中，利用翻译文法实施语法分析翻译。
4. 利用属性文法进行语法分析翻译

- 翻译文法是在描述语言的文法中加入语义动作符号形成的(属性文法是一种翻译文法)
  - 符号拓展为带有语义属性和同一规则内各属性间的运算规则
...
### 如何将一段代码翻译为中间代码（后缀、三元组、四元组）？
略

几种常用语句的翻译——能写出语义函数或语义动作
1. 算术表达式
2. 说明语句
3. 赋值语句
4. 逻辑表达式
